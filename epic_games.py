...
def get_my_library():
    ...
    try:
        ...
        if result.returncode != 0:
            print("⚠️ Legendary CLI returned an error. Are you authenticated?")
            return []
        ...
        print("❌ 'legendary' command not found. Run: pip install legendary-gl")
        return []
...
def send_email(games_to_claim):
    ...
    print(f"📧 Sending email for {len(games_to_claim)} games...")
    ...
    <body style="font-family: Arial, sans-serif; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #333; color: white; padding: 20px; text-align: center;">
                <h2 style="margin:0;">🚀 Free Games Alert</h2>
            </div>
...
if __name__ == "__main__":
    print("--- 🎮 Epic Games Checker Started ---")
